document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyTheme(mode) {
        // Target main content text and the specific heading
        ...
        if (mode === 'dark') {
            ...
            // Toggle other content text to white
    ...
    nextBtn?.addEventListener('click', () => {document.addEventListener('DOMContentLoaded', () => {
